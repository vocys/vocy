...
const (
	...
	TracerName = "github.com/vocys/vocy/backend/tracing"
	// MeterName should be passed to otel.Meter when create custom metrics.
	MeterName = "github.com/vocys/vocy/backend/metrics"
)
...
const (
	...
	DbProviderOracle        DbProvider = "postgres"
	defaultSqliteConnString string     = "data/vocy.db"
	defaultFsUploadPath     string     = "data/uploads"
	AppUrl                  string     = "http://localhost:7011"
)
